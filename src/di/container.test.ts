...
describe('IoC Container', () => {
  ...
  let dependencyOne = class dependencyOneClass {}
  let dependencyTwo = class dependencyTwoClass {}
  ...
  test('get method - checks for validity of the dependency name', () => {
    expect(() => container.get('')).toThrow(
      'Invalid dependency name provided to fetch'
    )
  })
  ...
  test('register method - checks for validity of the dependency name', () => {
    expect(() => container.register('', mockService)).toThrow(
      'Invalid dependency name provided to register'
    )
  })
