...
export class Container implements IContainer {
  ...
  private _services: Map<string, { definition: {}, dependencies: Array<string> }>;
  ...
  public register(name: string, definition: {}, dependencies: Array<string> = []) {
    try {
      if (!this._isValidName(name)) throw new Error(`Invalid dependency name provided to register`);
      if (!this._isValidDefinition(definition)) throw new Error(`Invalid dependency definition provided`);
